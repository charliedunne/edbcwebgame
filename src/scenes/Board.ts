...
export default class Board extends Phaser.Scene {
    ...
    create() {
        ...
        let card = new CardBase(
            ...
            {
                cost: 5, karma: 0, strength: 4, speed: 30,
                builder: 'saud kruger', model: 'orca', role: [ShipRole.liner]
            }
        );
        ...
        let card3 = new CardBase(
            ...
            { cost: 9, karma: 2, strength: 8, speed: 50, builder: 'Imperial Strike', model: 'Imperial Cutter', role: [ShipRole.figher, ShipRole.warship] });
        ...
        let card4 = new CardBase(
            ...
            130+3*side_x, 760,
            {
                id: 4, set: CardSet.core, title: "Enegize shields",
                type: CardType.outfitting, faction: CardFaction.neutral
            },
            { cost: 9, karma: 2});
        ...
        let card5 = new CardBase(
            ...
            130, 760+side_y,
            {
                id: 6, set: CardSet.core, title: "WTF",
                type: CardType.action, faction: CardFaction.neutral
            },
            { });
        ...
        let card6 = new CardBase(
            this,
            130+side_x, 760+side_y,
            {
                id: 6, set: CardSet.core, title: "Fuel Rats",
                type: CardType.ship, faction: CardFaction.neutral
            },
            { 
                cost: 2, karma: 1, strength: 2, speed: 80, 
                builder: 'Lakon', model: 'Type 6', 
        ...
        let card7 = new CardBase(
            this,
            130+2*side_x, 760+side_y,
            {
                id: 7, set: CardSet.core, title: "KillBlade",
                type: CardType.ship, faction: CardFaction.empire
            },
            { 
                cost: 7, karma: 2, strength: 5, speed: 50, 
                builder: 'Zorgon Peterson', model: 'Fer-de-lance', 
        ...
        let card8 = new CardBase(
            this,
            130+3*side_x, 760+side_y,
            {
                id: 7, set: CardSet.core, title: "Diamondback flux",
                type: CardType.ship, faction: CardFaction.federation
            },
            { 
                cost: 5, karma: 0, strength: 4, speed: 40, 
                builder: 'Lakon', model: 'Diamondback Scout', 
        ...
        this.input.on('gameobjectup', function (pointer:Phaser.Input.Pointer, object: CardBase) {
